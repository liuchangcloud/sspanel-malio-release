...
class UserController extends AdminController
{
    ...
    public function ajax($request, $response, $args)
    {
        ...
        foreach ($users as $user) {
            ...
            $sub_url = Config::get('subUrl') . LinkController::GenerateSSRSubCode($user->id, 0) . "?clash=1";
            ...
            $tempdata['op'] = '<a class="btn btn-brand" href="/admin/user/' . $user->id . '/edit">编辑</a>
                    ...
                    <a class="btn btn-brand copy-text" href="'.$sub_url.'" data-clipboard-text="'. $sub_url .' @click="copy">複製訂閲</a>

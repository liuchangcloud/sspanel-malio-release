...
class UserController extends AdminController
{
    ...
    public function ajax($request, $response, $args)
    {
        ...
        foreach ($users as $user) {
            ...
            $sub_url = $user->user_name ." ".Config::get('subUrl') . LinkController::GenerateSSRSubCode($user->id, 0) . "?clash=1";
            ...
            $tempdata['op'] = '<a class="btn btn-brand" href="/admin/user/' . $user->id . '/edit">编辑</a>
                    ...
                    <a class="copy-text btn btn-brand" href="##" onClick="navigator_clipboard(\''.$sub_url.'\')">複製訂閲</a>

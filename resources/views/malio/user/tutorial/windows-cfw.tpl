                      ...
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <a href="/client-download/windows/Clash.for.Windows-0.15.3-win.7z" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端(7-Zip)</a>
                            <a href="/client-download/windows/Clash.for.Windows.Setup.0.15.3.exe" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端(EXE)</a>
                          </div>

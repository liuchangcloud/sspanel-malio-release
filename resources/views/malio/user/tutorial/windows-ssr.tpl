            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="btn-group dropleft">
                ...
                <div class="dropdown-menu dropleft">
                  ...
                  <a class="dropdown-item has-icon" href="/user/tutorial?os=windows&client=v2ray"><i class="malio-clash"></i>Clash for Windows</a>
                </div>
              </div>
              {/if}
            </div>
                      ...
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <a href="/client-download/windows/ShadowsocksR-win-4.9.2.zip" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                          </div>

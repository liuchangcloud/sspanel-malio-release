            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="btn-group dropleft">
                ...
                <div class="dropdown-menu dropleft">
                  ...
                  <a class="dropdown-item has-icon" href="/user/tutorial?os=windows&client=ssr"><i class="malio-clash"></i>V2Ray</a>
                </div>
              </div>
              {/if}
            </div>
              ...
              <div class="col-12">
                ...
                <div class="alert alert-warning alert-has-icon">
                  ...
                  <div class="alert-body">
                    ...
                    您的加密、混淆和协议不兼容 V2Ray 客户端。如需使用，请在 <a href="/user/edit"><u>连接设置</u></a> 页面更改 “加密方式”、“混淆和协议” 为 V2Ray 可连接的选项。
                  </div>
                </div>
                {/if}
                <div class="card">
                      ...
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>下载 V2RayN 客户端，解压后以管理员身份运行 v2rayN.exe。若系统提示需要安装 .NET Framework，请<a href="https://www.microsoft.com/net/download/dotnet-framework-runtime" target="blank">点此</a>访问微软官网下载安装。</p>
                            <a href="/client-download/windows/v2rayN-Core.zip" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                          </div>
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>点击这个按钮 👇👇👇</p>
                            <a href="##" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" onclick="importSublink('ssr')"><i class="malio-ssr"></i> 一键导入订阅链接到 V2Ray</a>
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>再次右键点击v2rayN，选择 “服务器订阅” > “更新服务器订阅(不通过代理)”</p>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>右键点击v2rayN，选择 “服务器” > “{$config['appName']}”，可随意切换节点。选择节点后即可正常使用。</p>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                    ...
                    <div class="faq">
                      <div class="row mt-2 mb-2">
                        <div class="col-sm-6 col-xs-12 col-md-6 col-lg-6" id="manual-import">
                          <h6>V2Ray 无法一键导入，如何手动导入配置？</h6>
                          <p class="mb-4 font-13">
                            <a href="##" class="copy-text" data-clipboard-text="{$subInfo['ssr']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}">点此复制 V2Ray 订阅链接</a>，在状态栏找到v2rayN，右键点击，选中 “服务器订阅” > “SSR服务器订阅设置”，添加并粘贴订阅链接。
                          </p>
                        </div>
                      </div>
                    </div>
